...
public partial class Game : Node3D
{
	...
	//public static ArraySegment<Note> Notes;
	...
	public override void _Process(double delta)
	{
		...
		for (int i = PassedNotes; i < Map.Notes.Length; i++)
		{
		...
		for (int i = 0; i < ToProcess; i++)
		{
			...
			if (CursorPosition.X + Phoenix.Constants.CursorSize / 2 >= note.X - 0.5f && CursorPosition.X - Phoenix.Constants.CursorSize / 2 <= note.X + 0.5f)
			{
